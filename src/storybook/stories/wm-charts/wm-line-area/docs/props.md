        ...
        <details open>
          <summary>Chart</summary>
            <div>
              ...
              | `linethickness` | string | - | This (Origin) property controls the thickness of the line in chart. It accepts value likes "5px", "0.85em" (**Note**: This option is available only for the **Line** Chart).|
              | **Data Rendering** |  |  |  |
