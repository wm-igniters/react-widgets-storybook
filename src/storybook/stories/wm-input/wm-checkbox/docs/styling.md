...
- Checkbox container - The outer container that holds both the checkbox and its label
...
|---|---|
| backgroundColor | Background color of the checkbox indicator |
| borderColor | Border color of the checkbox indicator |
| color | Color of the checkmark when checked |
| fontSize | Font size of the label text |
| fontWeight | Font weight of the label text |
...
- Primary colors for checked state
