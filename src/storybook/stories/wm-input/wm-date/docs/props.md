...
<details open>
  <summary>Basic</summary>
    <div>
        ...
        | --- | --- | --- | --- |
        | `name` | string | - | A unique identifier for the date component. Special characters and spaces are not allowed. |
...
<details>
  <summary>Display Format</summary>
    <div>
        | Property | Type | Default | Description |
        | --- | --- | --- | --- |
        | `viewmode` | string | "day" | Show Date Component in day or month mode. |
        | `datepattern` | string | "MMM, d, y" | Date pattern lets you override how dates are displayed. Common options are 'dd-MMMM-yyyy', 'yyyy/MM/dd'. |
        | `showdateformatasplaceholder` | boolean | false | Show Display Format as placeholder in Date Component. |
    </div>
</details>
...
<details>
  <summary>Behavior</summary>
    <div>
        ...
        | `dataentrymode` | string | "default" | This property defines how the user can enter a date—either by selecting it from the date picker only or by both selecting from the picker and entering it manually. |
