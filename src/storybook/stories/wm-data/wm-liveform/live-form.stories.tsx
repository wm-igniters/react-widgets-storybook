          ...
          <div data-design-token-target="true">
            <WmLiveForm {...({
              ...
              <Box sx={{ padding: 3 }}>
                <Stack spacing={3}>
                  {/* Text Input */}
                  <WmComposite captionposition="top" required={true} listener={mockListener} name="stdFullName_composite">
                  ...
                  {/* Email Input */}
                  <WmComposite captionposition="top" required={true} listener={mockListener} name="stdEmail_composite">
                  ...
                  {/* Number Input */}
                  <WmComposite captionposition="top" listener={mockListener} name="stdPhone_composite">
                  ...
                  {/* Currency Input */}
                  <WmComposite captionposition="top" listener={mockListener} name="stdSalary_composite">
                  ...
                  {/* Date Input */}
                  <WmComposite captionposition="top" required={true} listener={mockListener} name="stdStartDate_composite">
                  ...
                  {/* Select Dropdown */}
                  <WmComposite captionposition="top" required={true} listener={mockListener} name="stdDepartment_composite">
                  ...
                  {/* Radio Button Set */}
                  <WmComposite captionposition="top" required={true} listener={mockListener} name="stdEmploymentType_composite">
                  ...
                  {/* Checkbox Set */}
                  <WmComposite captionposition="top" listener={mockListener} name="stdSkills_composite">
                  ...
                  {/* Switch */}
                  <WmComposite captionposition="top" listener={mockListener} name="stdRemote_composite">
                  ...
                  {/* Textarea */}
                  <WmComposite captionposition="top" required={true} listener={mockListener} name="stdExperience_composite">
